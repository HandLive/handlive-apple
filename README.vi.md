...
| `Packages/HLAppCore` | Trạng thái app không phụ thuộc nền tảng: khóa cài đặt (0.9.5), khóa định danh trong Keychain, capability của máy này, kho cặp mã hóa (`paired_device`) |
| `Packages/HLMacUI` | Model và view của app Mac: `AppModel`, `AppCoordinator` (khởi động, mở lại, ngủ/thức, thoát, menu Dock), menu và biểu tượng trên thanh menu, các ngăn Cài đặt, cửa sổ chào mừng (SET-03) và sheet ghép nối (PAIR-01) |
