...
struct AppCoordinatorTests {
    @Test("Dock menu: Add Phone… while unpaired; Send Clipboard to Phone dimmed while it can't be used")
    func dockMenu() {
        ...
        #expect(menu.items.map(\.title) == [L10n.Pairing.addPhone, L10n.Menu.sendClipboardToPhone])
